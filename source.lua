...
if not game:IsLoaded() then
	...
	if not success and err then
		notLoaded = Instance.new("Message", workspace)
	else
		notLoaded = Instance.new("Message", game:GetService("CoreGui"))
	end
...
CmdSu.Position = UDim2.new(0, 0, 0, 0)
CmdSu.Size = UDim2.new(0, 240, 0, 25)
CmdSu.Font = Enum.Font.SourceSans
CmdSu.TextSize = 18
CmdSu.TextXAlignment = Enum.TextXAlignment.Left
CmdSu.TextColor3 = Color3.fromRGB(171, 171, 171)
CmdSu.Text = ""
CmdSu.ZIndex = 10
...
CMDs[#CMDs + 1] = {NAME = 'getversion', DESC = "Compare the IY Plus version to IY FE"}
